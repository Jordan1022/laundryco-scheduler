...
describe('date-time picker parsing helpers', () => {
  ...
  it('rejects an invalid ISO date string', () => {
    expect(parseISODateOnlyAsLocal('2026-02-30')).toBeNull()
    expect(parseISODateOnlyAsLocal('not-a-date')).toBeNull()
  })
